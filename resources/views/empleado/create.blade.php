...
@section('subtitulo2', 'Nuevo Empleado')
               ...
               <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="cargo" id="cargo">
                                ...
                                <option value="Coord. Comercio Ext.">Coord. Comercio Ext.</option>
                ...
                <div class="row ">
                    <div class="text-center col-md-4 col-sm-12">
                        ...
                        <button class="btn bg-gradient-primary w-100 mt-4 mb-0"> Agregar Empleado </button> 
                    </div>
                </div>

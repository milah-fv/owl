...
@section('subtitulo2', 'Nuevo Agente Ad. de Importación')
...
<div class="container-fluid py-4">
    <div class="row mt-4">
        <form action="{{url('/ag_ad_importacion')}}" method="post" enctype="multipart/form-data">
           @csrf
           @include('agente_ad_importacion.form', ['modo'=>'Registrar'])
       </form>
   </div>
</div>
@endsection

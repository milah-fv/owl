...
@section('subtitulo2', 'Nuevo Agente Ad. de Exportación')
...
<div class="container-fluid py-4">
    <div class="row mt-4">
        <form action="{{url('/ag_ad_exportacion')}}" method="post" enctype="multipart/form-data">
           @csrf
           @include('agente_ad_exportacion.form', ['modo'=>'Registrar'])
       </form>
   </div>
</div>
@endsection

...
@section('titulo', 'Editar Agente Aduanal de Exportación')
@section('subtitulo1', 'Agente Aduanal de Exportación')
@section('subtitulo2', 'Editar Agente Ad. de Exportación')
...
<div class="container-fluid py-4">
	<div class="row mt-4">
		<form action="{{ url( '/ag_ad_exportacion/'.$agente_ad_exportacion->id ) }}" method="post" enctype="multipart/form-data">
			@csrf
			{{method_field ('PATCH') }}
		
			@include('agente_ad_exportacion.form', ['modo'=>'Actualizar'])
		</form>
	</div>
</div>
@endsection

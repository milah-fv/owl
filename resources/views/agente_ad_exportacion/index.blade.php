              ...
              <tbody>
                ...
                <tr>
                  <td  class="align-middle text-center">
                    <p class="text-sm font-weight-bold mb-0">{{$agente_ad_exportacion->id}}</p>
                  </td>
                  <td>
                    <div class="my-auto">
                      <h6 class="mb-0 text-sm">{{$agente_ad_exportacion->nombre}}</h6>
                    </div>
                  </td>
                  <td >
                    <div class="my-auto">
                      <p class="text-sm font-weight-bold mb-0">{{$agente_ad_exportacion->rfc}}</p>
                    </div>
                  </td>
                  <td>
                  ...
                  <td class="align-middle text-center">
                    <form action="{{ url('/ag_ad_exportacion/'.$agente_ad_exportacion->id) }}" method="post" class="formEliminar">
                      @csrf
                      {{method_field('DELETE')}}
                      <a class="btn btn-link text-dark px-3 mb-0" href="{{ url('/ag_ad_exportacion/'.$agente_ad_exportacion->id.'/edit') }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Editar</a>

...
@section('titulo', 'Editar Importador')
@section('subtitulo1', 'Importadores')
@section('subtitulo2', 'Editar Importador')
...
<div class="container-fluid py-4">
	<div class="row mt-4">
		<form action="{{ url( '/importador/'.$importador->id ) }}" method="post" enctype="multipart/form-data">
			@csrf
			{{method_field ('PATCH') }}
		
			@include('importador.form', ['modo'=>'Actualizar'])
		</form>
	</div>
</div>
@endsection

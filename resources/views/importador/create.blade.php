...
@section('titulo', 'Crear Importador')
@section('subtitulo1', 'Importadores')
@section('subtitulo2', 'Nuevo Importador')
...
<div class="container-fluid py-4">
    <div class="row mt-4">
        <form action="{{url('/importador')}}" method="post" enctype="multipart/form-data">
           @csrf
           @include('importador.form', ['modo'=>'Registrar'])
       </form>
   </div>
</div>
@endsection

...
@section('titulo', 'Crear Exportador')
@section('subtitulo1', 'Exportadores')
@section('subtitulo2', 'Nuevo Exportador')
...
<div class="container-fluid py-4">
    <div class="row mt-4">
        <form action="{{url('/exportador')}}" method="post" enctype="multipart/form-data">
           @csrf
           @include('exportador.form', ['modo'=>'Registrar'])
       </form>
   </div>
</div>
@endsection

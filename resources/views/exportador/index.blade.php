              ...
              <tbody>
                ...
                <tr>
                  <td  class="align-middle text-center">
                    <p class="text-sm font-weight-bold mb-0">{{$exportador->id}}</p>
                  </td>
                  <td>
                    <div class="my-auto">
                      <h6 class="mb-0 text-sm">{{$exportador->nombre}}</h6>
                    </div>
                  </td>
                  <td >
                    <div class="my-auto">
                      <p class="text-sm font-weight-bold mb-0">{{$exportador->rfc}}</p>
                    </div>
                  </td>
                  <td>
                  ...
                  <td class="align-middle text-center">
                    <form action="{{ url('/exportador/'.$exportador->id) }}" method="post" class="formEliminar">
                      @csrf
                      {{method_field('DELETE')}}
                      <a class="btn btn-link text-dark px-3 mb-0" href="{{ url('/exportador/'.$exportador->id.'/edit') }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Editar</a>

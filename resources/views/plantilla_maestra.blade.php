...
<head>
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-RGS1WD7DF1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-RGS1WD7DF1');
  </script>
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="/">
      <img src="{{ asset('app_assets/img/logo-ct.png') }}" class="navbar-brand-img h-100" alt="main_logo">
      <span class="ms-1 font-weight-bold">Panel de Administración</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    ...
    @section('menu-2')
      <li class="nav-item">
        ...
        <ul class="nav ms-4 ps-2" >
          <li class=" collapse" id="collapseExportacion">
    ...
    @section('menu-3')
      <li class="nav-item">
        ...
        <ul class="nav ms-4 ps-2" >
          <li class=" collapse" id="collapseImportacion">
    ...
    @section('menu-6')
      <li class="nav-item">
        <a class="nav-link  " href="/descmercaderia">
          <div
            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">@yield('subtitulo1')</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">@yield('subtitulo2')</h6>
        </nav>
